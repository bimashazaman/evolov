...
import FilterPhone from "../../../components/Boat/Rent_Boat/FilterPhone";
import { Suspense } from "react";
import SubSearch from "../../../components/Search/SubSearch";
import Layout from "../../../components/Layout";
import { Arts } from "../../../data/market/data";
import Breadcrumb from "../../../components/Boat/Rent_Boat/Breadcrumb";
import Filters from "../../../components/Boat/Rent_Boat/Filters";
    ...
    <>
      <Suspense fallback={<div>Loading...</div>}>
        <div className="bg-[#F9FAFF]">
          <Layout>
            <div className="flex">
              <div className=" w-72  hidden py-16 pl-10 lg:block md:block">
                <Breadcrumb />
                <Filters />
              </div>
                      ...
                      <div className="flex justify-between">
                        <div className="p-3 text-lg flex-col font-semibold text-[#221F60] font-mono">
                          ...
                          <div className="text-sm font-normal">
                            {" "}
                            {`Salary: ${item["currency"]} ${item["price"]}`}{" "}
                          </div>
                        </div>

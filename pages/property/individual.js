...
import IndevidualSellerCard from "../../components/AboutSeller/Individual";
          ...
          <div className="text-3xl text-[#221F60]  font-semibold mb-2 lg:px-32 px-9">
            ...
            <div className="flex justify-between lg:px-10">
              <div>
                ...
                <div className="mb-2 text-sm font-normal">Size: 2345 sqft</div>
              </div>
              <div className="mt-7">
                <div className="mb-2 text-sm font-normal">Bedrooms: 2</div>
                <div className="mb-2 text-sm font-normal">Renovated: 2015</div>

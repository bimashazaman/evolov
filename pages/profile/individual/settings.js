      ...
      <div className="bg-[#F9FAFF]">
        ...
        <div className="flex">
          ...
          <div className="w-full lg:px-[5%] pl-16 ">
            ...
            <div className="bg-white shadow-md rounded-lg p-4 mb-10">
              <div className="flex justify-between">
                <div className="text-2xl font-semibold">Account Switching</div>
              </div>
              <div className="text-sm font-semibold text-gray-400">
                Switch to a business account to get more features
              </div>
              <br />
              <div className="flex justify-between">
                <div className="text-lg font-semibold">
              ...
              <div className="text-sm font-semibold text-gray-400">
                Your account will be switched to a business account
              </div>
              <br />
            </div>
